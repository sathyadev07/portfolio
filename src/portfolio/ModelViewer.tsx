...
/* A viewer's WebGL context, model download and shader compiles cost hundreds
   ...
   - renders frames only while both still hold, so it neither competes with
     the close morph nor burns GPU while scrolled out of sight.
   Once mounted the canvas stays mounted (frameloop 'never' pauses it), so
   scrolling back does not pay the setup cost again. */
