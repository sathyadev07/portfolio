...
export default function VideoPlayer({number}:{number:number}){
 ...
 {playing
  /* Tilt (when PANEL_TILT_ENABLED) stays on while playing: useTilt suspends
     itself on pointerdown, so a drag on the scrubber flattens the panel first
     and lands on real controls. */
